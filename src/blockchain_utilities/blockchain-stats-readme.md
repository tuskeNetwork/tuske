...
See also the utility's help option. `tuske-blockchain-stats --help`

From the command line run:

`$ tuske-blockchain-stats`
...
- `tuske-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `tuske-blockchain-stats | save-to-database.sh`
